...
public class MultyEntityController
{
    ...
    public GeneralResponseWithMessage<MultiEntity> save(@RequestBody @Validated MultyEntitySave body) {
    ...
    @ResponseStatus(HttpStatus.OK)
    public GeneralResponseWithMessage<MultiEntity> modifyById(@PathVariable Long id, @RequestBody MultyEntityRequestModify request) {
    ...
    @GetMapping("/fetchall")
    @ResponseStatus(HttpStatus.OK)
    public GeneralResponseWithMessage<Page<MultiEntity>> findAll(@RequestParam(defaultValue = "0") int page,
